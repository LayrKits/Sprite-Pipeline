...
from horizontal_align_sheet import alpha_bbox, save_sheet, shift_frame_horizontal, split_sheet
...
def run(args: argparse.Namespace) -> dict[str, object]:
    ...
    adjusted_frames = [
        shift_frame_horizontal(frame, offset)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply manual per-frame horizontal offsets to an alignment candidate sheet.")
